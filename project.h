...
struct LLNode
{
	...
	bool onDisplay; //^^if this is true gallery number will be displayed
...
class ArtMuseum
{
	public:
		...
		void deletePeice(std::string title);
		...
		bool isOnDisplay(); //lets you know if peice is in gallery right now 
